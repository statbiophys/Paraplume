...
train=/home/gathenes/paragraph_benchmark/241106/train_set
val=/home/gathenes/paragraph_benchmark/241106/val_set
test=/home/gathenes/paragraph_benchmark/241106/test_set
folder=/home/gathenes/paragraph_benchmark/241106/
lrs=("0.00001")
batch_norms=("")
...
convexs=("")
distances=("")
alphas=("5.5" "4,5,6" "4,5,5.5,6,6.5" "3,3.5,4,5,5.5,6,6.5,7,7.5")
                                ...
                                for bg in "${bigembeddings[@]}" ; do
                                    for cv in "${convexs[@]}" ; do
                                        for ds in "${distances[@]}" ; do
                                            ...
                                            python train.py $train $val -n 500 --lr $lr --dropouts $dr --mask-prob $mk -bs $bs --dims $d1 -r $result_folder --alphas $alpha --l2-pen $pen --pos-weight $weight $bg $cv $ds > $result_folder/train_logs.txt
