...
batch_norms=("")
dropouts=("0.4,0.3,0.2,0.2" "0.4,0.4,0.2,0.2" "0.4,0.4,0.3,0.2")
maskprobs=("0.4")
batchsizes=("15" "20" "25" "40")
                        ...
                        for pen in "${l2_pens[@]}" ; do
                            for weight in "${weights[@]}" ; do
                                for bg in "${bigembeddings[@]}" ; do
                                    ...
                                    result_folder=$folder/lr-${lr}_dr-${dr}_mk-${mk}_bs-${bs}_dim1-${d1}_alpha-${alpha}_pen-${pen}_weight_${weight}_${bg}_multi
