...
train=/home/athenes/Paraplume/benchmark/pecan/train_set
val=/home/athenes/Paraplume/benchmark/pecan/val_set
test=/home/athenes/Paraplume/benchmark/pecan/test_set
test_csv="/home/athenes/Paraplume/datasets/pecan/test_set.csv"
pdb_folder="/home/athenes/all_structures/imgt_renumbered_pecan"

folder=/home/athenes/Paraplume/benchmark/pecan/250526
...
for seed in "${seeds[@]}"; do
    ...
    python paraplume/train.py "$train" "$val" --gpu 0 -n 500 --lr "$lr" --dropouts "$dr" --mask-prob "$mk" -bs "$bs" --dims "$d1" -r "$result_folder" --alphas "$alpha" --l2-pen "$pen" --pos-weight "$weight" --seed "$seed" --emb-models "$emb" --patience 20 > "$result_folder/train_logs.txt"
