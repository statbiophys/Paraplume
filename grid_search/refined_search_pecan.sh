...
train=/home/athenes/benchmark/pecan/train_set
val=/home/athenes/benchmark/pecan/val_set
test=/home/athenes/benchmark/pecan/test_set
folder=/home/athenes/benchmark/pecan/241213/
lrs=("0.00001")
batch_norms=("")
                                    ...
                                    for ds in "${distances[@]}" ; do
                                        for seed in "${seeds[@]}" ; do
                                            for emb in "${embeddings[@]}" ; do
                                                ...
                                                python train.py $train $val -n 500 --lr $lr --dropouts $dr --mask-prob $mk -bs $bs --dims $d1 -r $result_folder --alphas $alpha --l2-pen $pen --pos-weight $weight $cv $ds --seed $seed --emb-models $emb --patience 10 > $result_folder/train_logs.txt
