...
folder=/home/athenes/benchmark/graph/paragraph_241226/
...
for i in $(seq 1 $num_samples); do
    ...
    echo "Sample $i: learning rate $lr, dropout $dr, maskprob $mk, depth $depth, l2_pen $pen, graph distance $gd, embedding $emb weight $w linear dims $ld"
    ...
    python train_graph_light.py $train $val $train_csv $val_csv -n 500 \
        ...
        --patience 75 --pdb-folder-path-train $pdb_folder_path --pdb-folder-path-val $pdb_folder_path \
