...
train=/home/athenes/benchmark2/mipe/train_val
test=/home/athenes/benchmark2/mipe/test_set
folder=/home/athenes/benchmark2/mipe/250106/
lrs=("0.00005")
batch_norms=("")
                                    ...
                                    for ds in "${distances[@]}" ; do
                                        for seed in "${seeds[@]}" ; do
                                            for emb in "${embeddings[@]}" ; do
                                                ...
                                                python train.py $train $test --override -n 500 --lr $lr --dropouts $dr --mask-prob $mk -bs $bs --dims $d1 -r $result_folder --alphas $alpha --l2-pen $pen --pos-weight $weight $cv $ds --seed $seed --emb-models $emb --patience 10 --override --gpu 1 > $result_folder/train_logs.txt
