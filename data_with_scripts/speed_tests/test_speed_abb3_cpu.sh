...
for seed in 0; do
    for size in 1 10 100 1000 10000; do
        ...
        start_time=$(date +%s)
        python /home/athenes/Paraplume/data_with_scripts/speed_tests/compute_3D_structures.py /home/athenes/Paraplume/data_with_scripts/speed_tests/test$size.csv
        end_time=$(date +%s)
